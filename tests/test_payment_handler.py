...
from src.handlers.payment import handle_payment_request, extract_amount_from_message, handle_deposit_confirmation
...
class TestPaymentHandler:
    ...
    @pytest.mark.asyncio
    @patch('src.handlers.payment.get_user_address')
    async def test_handle_payment_request_valid_amount(self, mock_get_address, clear_app_state):
    ...
    @pytest.mark.asyncio
    @patch('src.handlers.payment.get_user_address')
    async def test_handle_payment_request_exception(self, mock_get_address, clear_app_state):
